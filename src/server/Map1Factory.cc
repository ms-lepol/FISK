...
namespace fisk {
    ...
    std::unique_ptr<Game> createModelForMap1(){
        ...
        gf::Log::debug("here\n");
        LandId NorthwestTerritory = model->add_land(Land(0, "Northwest Territory", {}, gf::InvalidId));
        ...
        LandId WesternUnitedStates = model->add_land(Land(0, "Western United States", {}, gf::InvalidId));
        model->get_continent(NorthAmerica).add_land(WesternUnitedStates);
        LandId EasternUnitedStates = model->add_land(Land(0, "Eastern United States", {}, gf::InvalidId));
        model->get_continent(NorthAmerica).add_land(EasternUnitedStates);
        LandId CentralAmerica = model->add_land(Land(0, "Central America", {}, gf::InvalidId));
        ...
        LandId GreatBritain = model->add_land(Land(0, "Great Britain", {}, gf::InvalidId));
        ...
        LandId NorthernEurope = model->add_land(Land(0, "Northern Europe", {}, gf::InvalidId));
        model->get_continent(Europe).add_land(NorthernEurope);
        LandId SouthernEurope = model->add_land(Land(0, "Southern Europe", {}, gf::InvalidId));
        model->get_continent(Europe).add_land(SouthernEurope);
        LandId WesternEurope = model->add_land(Land(0, "Western Europe", {}, gf::InvalidId));
        model->get_continent(Europe).add_land(WesternEurope);
        LandId EasternEurope = model->add_land(Land(0, "Eastern Europe", {}, gf::InvalidId));
        model->get_continent(Europe).add_land(EasternEurope);
        LandId NorthAfrica = model->add_land(Land(0, "North Africa", {}, gf::InvalidId));
        ...
        LandId EastAfrica = model->add_land(Land(0, "East Africa", {}, gf::InvalidId));
        ...
        LandId SouthAfrica = model->add_land(Land(0, "South Africa", {}, gf::InvalidId));
        ...
        LandId MiddleEast = model->add_land(Land(0, "Middle East", {}, gf::InvalidId));
        ...
        LandId NewZealand = model->add_land(Land(0, "New Zealand", {}, gf::InvalidId));
        model->get_continent(Oceania).add_land(NewZealand);
        LandId WesternAustralia = model->add_land(Land(0, "Western Australia", {}, gf::InvalidId));
        model->get_continent(Oceania).add_land(WesternAustralia);
        LandId EasternAustralia = model->add_land(Land(0, "Eastern Australia", {}, gf::InvalidId));
